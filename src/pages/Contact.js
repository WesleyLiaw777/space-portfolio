    ...
    sendForm(
      ...
      .then(
        ...
        (err) => {
          ...
          alert(
            "My email service is temporarily unavailable. I’d still love to hear from you, so please email me directly at me@wesleyliaw.com.com"
          );
        }
      )
      .catch((e) => {
        ...
        setHeaderText({ text: "Something went wrong", modifier: "-error" });
        alert(
          "My email service is temporarily unavailable. I’d still love to hear from you, so please email me directly at me@wesleyliaw.com"
        );
      });
  };

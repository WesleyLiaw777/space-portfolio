    ...
    <div className="container" id="about">
      <div className="about__wrapper" data-aos="fade-down" data-aos-delay="50">
        ...
        <div className="about__right lato">
          I've developed e-commerce websites, movie databases, and top tech
          clones using React, HTML, CSS, and JavaScript best practices.
          <br />
          <br />
          I'm continuously working towards improving my knowledge and skills to optimize business and quality of life for all.
        </div>
      </div>

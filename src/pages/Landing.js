    ...
    <div id="landing" className="container" data-aos="fade-in">
      <div className="landing__text-container">
        ...
        <div className="landing__iconscontainer">
          <a target="_blank" rel="no-refferer" href="https://github.com/WesleyLiaw777/">
            <img src={gitHubIcon} alt="gitHubIcon" />
          </a>
          <a target="_blank" rel="no-refferer" href="https://www.linkedin.com/in/wesleyliaw/">
